...
<body>
    ...
    <emvh:set var="insertURL">
        <emvh:url value="insert.jsp">
            <emvh:set var="listRole" value="${requestScope.listRole}" scope="session"/>
        </emvh:url>
        
    </emvh:set>
    <a href="${insertURL}"><input type="button" value="Add new"/></a>
    ...
    <form id="myForm" action="MainController" method="POST" onsubmit="return checkForm(this);">
        ...
        <input type="submit" value="Change to Admin" name="action" onsubmit="return false"/>
        ...
        <emvh:if test="${empty requestScope.listUser}">
            <br/>
            <font color="red">
            No record found.
            </font>
...
//        }
    function checkForm(form) {
        var checkedValue = document.querySelector('.checkboxlist:checked');
        if (checkedValue == null) {
            alert("Have no user has been selected!!");
            return false;
        }
        return true;
    }
